...
/*管理员*/
CREATE TABLE HotPot_admin(
  aid INT PRIMARY KEY AUTO_INCREMENT,
  aname VARCHAR(32) UNIQUE,
  apwd VARCHAR(64)
);
INSERT INTO HotPot_admin VALUES
(NULL, 'admin', PASSWORD('123456')),
(NULL, 'boss', PASSWORD('999999'));

/*全局设置*/
CREATE TABLE HotPot_settings(
...
INSERT INTO HotPot_settings VALUES
(NULL, 'HotPot', 'http://127.0.0.1:8090', 'http://127.0.0.1:8091', 'http://127.0.0.1:8092', 'ICP12003709-3', 'Copyright © londonxxxxxxxxxxx');

/*桌台表*/
CREATE TABLE HotPot_table(
  tid INT PRIMARY KEY AUTO_INCREMENT,
  tname VARCHAR(32),
  type VARCHAR(32),
  status INT
);
INSERT INTO HotPot_table VALUES
(1, '金镶玉', '2人桌', 1),
(2, '玉如意', '2人桌', 1),
(3, '齐天寿', '6人桌', 3),
(5, '福临门', '4人桌', 2),
...
/*桌台预定信息*/
CREATE TABLE HotPot_reservation(
  ...
  dinnerTime BIGINT,
  tableId INT,
  FOREIGN KEY(tableId) REFERENCES HotPot_table(tid)
);
INSERT INTO HotPot_reservation VALUES
...
/*菜品类别*/
CREATE TABLE HotPot_category(
  cid INT PRIMARY KEY AUTO_INCREMENT,
  cname VARCHAR(32)
);
INSERT INTO HotPot_category VALUES
(1, '肉类'),
(2, '海鲜河鲜'),
(3, '丸滑类'),
(4, '蔬菜豆制品'),
...
CREATE TABLE HotPot_dish(
  ...
  detail VARCHAR(128),
  categoryId INT,
  FOREIGN KEY(categoryId) REFERENCES HotPot_category(cid)
);
INSERT INTO HotPot_dish VALUES
...
INSERT INTO HotPot_order VALUES
...
/*订单详情*/
CREATE TABLE HotPot_order_detail(
  oid INT PRIMARY KEY AUTO_INCREMENT,
  dishId INT,       /*菜品编号*/
  dishCount INT,    /*份数*/
  customerName VARCHAR(32),    /*顾客名称*/
  orderId INT,      /*订单编号*/
  FOREIGN KEY(dishId) REFERENCES HotPot_dish(did),
  FOREIGN KEY(orderId) REFERENCES HotPot_order(oid)
);
INSERT INTO HotPot_order_detail VALUES
(NULL, '50', '2', '丁丁', '100000'),
(NULL, '24', '2', '丁丁', '100001'),
(NULL, '37', '1', '当当', '100002'),
(NULL, '18', '3', '豆豆', '100003'),
